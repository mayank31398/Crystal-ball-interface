...
void reshape(int width, int height)
{
	...
	// the calculated matrix onto the shader program. The perspective field of view should be in radians.
...
void init()
{
	...
	// Except that 2 point lights are used.
	// Lights and materials are set in display. Will move to init later, per update lights
